...
const ButtonExplore = () => {
  return (
    <button
      className="inline-flex items-center gap-2 rounded-3xl px-8 py-4 hover:bg-white"
      /* style={{
        background:
          "linear-gradient(54.84deg, #E900A9 -36.72%, #E502AC -16.52%, #D806B5 5.22%, #C20EC5 28.53%, #A318DA 53.38%, #7D25F5 76.68%, #6F2AFF 84.45%)",
      }} */
    >
